...
curl -X POST http://localhost:8080/api/dishes -H "Content-Type: application/json" -d '{
  ...
  "description": "Классический салат Цезарь с сочным куриным филе и хрустящими гренками.",
  "category": "Dish",
...
curl -X POST http://localhost:8080/api/dishes -H "Content-Type: application/json" -d '{
  ...
  "description": "Итальянская паста в сливочном соусе с ароматным беконом.",
  "category": "Dish",
...
curl -X POST http://localhost:8080/api/dishes -H "Content-Type: application/json" -d '{
  ...
  "description": "Нежный рыбный суп с форелью и сливками.",
  "category": "Dish",
  "src": "./src/assets/products/fish_soup.png"
}'
...
curl -X POST http://localhost:8080/api/deserts -H "Content-Type: application/json" -d '{
  ...
  "description": "Итальянский десерт с нежным кремом и ароматным кофе.",
  "category": "Desert",
...
curl -X POST http://localhost:8080/api/deserts -H "Content-Type: application/json" -d '{
  ...
  "description": "Классическое сливочное мороженое с насыщенным вкусом.",
  "category": "Desert",
